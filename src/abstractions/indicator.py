...
from arcade import SpriteList, color, SpriteSolidColor

if TYPE_CHECKING:
    from src.abstractions.sprite import BasicSprite


class BasicIndicatorBar(ABC):
    """
    ...
    def __init__(
        ...
        height: int,
        border_size: int,
        full_color: color = color.GREEN,
        background_color: color = color.GRAY,
        ...
        self._background_box = SpriteSolidColor(
            self._bar_width + border_size,
            self._bar_height + border_size,
            color=background_color,
        )
        self._full_box = SpriteSolidColor(
            self._bar_width,
            self._bar_height,
            color=full_color,
        )
    ...
    @property
    def background_box(self) -> SpriteSolidColor:
        """Returns the background box of the indicator bar."""
        return self._background_box

    @property
    def full_box(self) -> SpriteSolidColor:
